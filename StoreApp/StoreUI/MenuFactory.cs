        ...
        public static IMenu GetMenu(string menuType) {
            ...
            switch (menuType.ToLower()) {
                case "main":
                    ...
                    case "manager":
                        return new ManagerMenu(new CustomerBL(new RepoDB(context)), new LocationBL(new RepoDB(context)), new ProductBL(new RepoDB(context)), new InventoryBL(new RepoDB(context), new LocationBL(new RepoDB(context)), new ProductBL(new RepoDB(context))), new OrderBL(new RepoDB(context)), new LineItemBL(new RepoDB(context)), new ValidationService());
